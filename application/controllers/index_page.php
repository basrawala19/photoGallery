       ...
       $url = base_url( ) ;
        ...
        <div id="main">
            ...
            <?php foreach ($photos as $photo ) : ?>
                    ...
                    <a href="http://localhost/CodeIgniter_2.2.0/index.php/photo/index/?id=<?php echo $photo->id ; ?>&gallery_name=<?php echo $_GET['gallery_name']; ?>" ><span style="padding-left:6em;"  class="photos" id=<?php echo $photo->id; ?>><img class="p" id=<?php echo $photo->id; ?> src="http://localhost/CodeIgniter_2.2.0/<?php echo $photo->image_path()?>" width='400' height ='300' vspace="10" hspace="2"/></span></a>
