...
class Hybrid_Providers_Google extends Hybrid_Provider_Model_OAuth2
{
	...
	*/
	function getUserProfile()
	{
		...
		$this->user->profile->external_id    = (property_exists($response,'id'))?$response->id:"";
		...
		$this->user->profile->profileURL    = "https://profiles.google.com/" . $this->user->profile->external_id;
